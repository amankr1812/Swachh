...
public class WaterIssue extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_issue);
...
// gps work
        gps=new GPSTracker(WaterIssue.this);
...
//        String message = editTextMessage.getText().toString().trim();
        ...
        msg="I request you to kindly take action to Repair the water issue in following area whose address is given below. A picture of the same has been attached with this mail. Kindly have a look and respond as soon as possible.\n"+"\nThe Latitude Is : "+latitude+".\n\nThe Longitude Is : "+longitude+"\n\n"+locationAddress;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i= new Intent(WaterIssue.this,HomePage.class);
            startActivity(i);
        }
