...
public class ProfileFragmentSanitation extends Fragment {
    TextView prof_name;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle args) {
        View view = inflater.inflate(R.layout.activity_profile_fragment_sanitation, container, false);
    ...
    private class PostTweet extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                twitter4j.Status response = twitter.updateStatus(tweetText +" #SanitationIssues ");//********HERE WE GIVE THE MINISTRY'S '@' LINK********
