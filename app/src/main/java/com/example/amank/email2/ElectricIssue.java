...
public class ElectricIssue extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_issue);
...
// gps work
        gps=new GPSTracker(ElectricIssue.this);
...
//        String message = editTextMessage.getText().toString().trim();
        ...
        sub="REQUEST FOR REPAIR OF THIS AREA";
        msg="I request you to kindly take action to Repair the Electric issue in following area whose address is given below. A picture of the same has been attached with this mail. Kindly have a look and respond as soon as possible.\n"+"\nThe Latitude Is : "+latitude+".\n\nThe Longitude Is : "+longitude+"\n\n"+locationAddress;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i= new Intent(ElectricIssue.this,HomePage.class);
            startActivity(i);
        }
