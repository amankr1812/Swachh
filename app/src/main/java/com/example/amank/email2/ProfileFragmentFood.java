...
public class ProfileFragmentFood extends Fragment {
    TextView prof_name;
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle args) {
        View view = inflater.inflate(R.layout.activity_profile_fragment_food, container, false);
    ...
    private class PostTweet extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                twitter4j.Status response = twitter.updateStatus(tweetText +" #FoodIssues ");//********HERE WE GIVE THE MINISTRY'S '@' LINK********
